...
fun ViewMultiFloatingButton(){
    MultiFloatingActionButton(fabIcon = painterResource(id = com.stoffe.gym.R.drawable.ic_baseline_add_24), items = arrayListOf(FabItem(icon =  Icons.Filled.Person, label = "",{})))
}
