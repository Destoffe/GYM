        ...
        return ComposeView(requireContext()).apply {
            ...
            setContent {
                ...
                WorkoutScreen(
                    ...
                    navController = NavHostFragment.findNavController(this@WorkoutFragment),
                    onBackArrowClick = { NavHostFragment.findNavController(this@WorkoutFragment).popBackStack()},
                    onCreateExercise = {
